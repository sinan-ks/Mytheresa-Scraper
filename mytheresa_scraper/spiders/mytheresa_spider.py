...
class MytheresaSpider(scrapy.Spider):
    ...
    def parse_product(self, response):
        item = {
            ...
            'listing_price': response.css('span.pricing__prices__value--original span.pricing__prices__price::text').getall()[1],
            'offer_price': response.css('span.pricing__prices__value--discount span.pricing__prices__price::text').getall()[1],
